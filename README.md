# utl-python-scrape-web-page-source-and-save-to-local-file-like-view-source-but-programatically
python scrape web page source and save to local file like view source but programmatically
